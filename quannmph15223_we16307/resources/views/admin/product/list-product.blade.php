  ...
  <table class="table">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>
          <button id="deleteProduct" class="btn btn-danger delete-product" data-url="{{route('admin.product.delete-product', $item->id)}}" data-id="{{ $item->id }}" data-token="{{ csrf_token() }}" >Delete</button>
