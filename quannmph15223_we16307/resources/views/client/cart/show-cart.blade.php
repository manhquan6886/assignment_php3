                            ...
                            <tbody>
                                ...
                                <tr id="quantity_load" class="quantity_load">
                                    ...
                                    <td class="pro-quantity">
                                        <div class="pro-qty"><input type="number" min="1" data-class="update-price{{$cart['product_id']}}" class="update_quantity" data-url="{{route('client.cart.add-quantity', $cart['product_id'])}}" data-token="{{ csrf_token() }}" data-id="{{$cart['product_id']}}" value="{{$cart['quantity']}}"></div>
                                    </td>
                                ...
                                <form action="{{route('client.cart.order')}}" method="POST">
                                    @csrf
                                      <div class="mb-3">
                                        ...
                                        <input type="text" value="{{Auth::user()->name}}" class="form-control" name="fullname" id="exampleInputEmail1" aria-describedby="emailHelp">
                                      ...
                                      <div class="mb-3">
                                        ...
                                        <input type="text" name="address" value="{{Auth::user()->address}}" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
